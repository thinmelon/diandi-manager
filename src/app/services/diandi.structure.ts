...
export const PrivilegeSet = [
    ...
    '帐号服务权限',                   //  帮助认证、设置公众号，进行账号管理
    '网页服务权限',                   //  帮助公众号实现第三方网页服务和活动
    '微信小店权限',                   //  5   帮助公众号使用微信小店
    '微信多客服权限',
    '群发与通知权限',                 //  帮助公众号进行群发和模板消息业务通知
    '微信卡券权限',                   //  帮助公众号使用微信卡券
    '微信扫一扫权限',                 //  使用扫一扫
    '微信连WIFI权限',                 //  10  使用微信连WIFI
    '素材管理权限',                   //   帮助公众号管理多媒体素材，用于客服等业务
    '微信摇周边权限',                 //  使用微信摇周边
    '微信门店权限',                   //  使用微信门店
    '微信支付权限',
    '自定义菜单权限',                 //  15  帮助公众号使用自定义菜单
    '获取认证状态及信息',
    '帐号管理权限（小程序）',
    '开发管理与数据分析权限（小程序）',
    '客服消息管理权限（小程序）',
    '微信登录权限（小程序）',          //  20
    '数据分析权限（小程序）',
    '城市服务接口权限',                // 帮助城市服务内的服务向用户发送消息，沉淀办事记录，展示页卡及办事结果页
    '广告管理权限',                    // 帮助广告主进行微信广告的投放和管理
    '开放平台帐号管理权限',            // 绑定开放平台账号，实现用户身份打通
    '开放平台帐号管理权限（小程序）',  // 25
    '微信电子发票权限',                // 使用微信电子发票
    '快速注册小程序权限',              // 快速注册小程序
    '',
    ...
    '小程序管理权限',                  //  可新增关联小程序
    '',
    '微信卡路里权限',                  //  35  提供用户卡路里同步、授权查询和兑换功能
    '微信卡路里权限（小程序）',
    '附近地点权限',
    '',
    '',
